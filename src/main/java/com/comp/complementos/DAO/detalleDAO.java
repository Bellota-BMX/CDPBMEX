...
public class detalleDAO {
   ...
   //DETALLE DCP
    int transaccion, numFactura, parcialidad;
    double ldSaldoAnterior, ldMontoPagado, ldNvoSaldo;
    String lsMoneda, lsBanco, lsCuenta, lsRFCBanco, lsMensaje, lsMensaje2, lsPrefijo;
